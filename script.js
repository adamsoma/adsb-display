...
function initialize() {
	...
	/*loadJSON(function(response) {
		var sys_JSON = JSON.parse(response);
...
function initialize_map() {
	...
	PlaneRowTemplate.cells[0].style.display = 'none';
	document.getElementById("icao").style.display = 'none';
	PlaneRowTemplate.cells[3].style.display = 'none';
	document.getElementById("squawk").style.display = 'none';
	PlaneRowTemplate.cells[8].style.display = 'none';
...
function startTime() {
	...
	document.getElementById("time_text").innerHTML = dateStr;
...
function getJSON() {
	loadJSON(function(response) {
		var sys_JSON = JSON.parse(response);
		document.getElementById("latitude_text").innerHTML = sys_JSON.latitude;
		document.getElementById("longitude_text").innerHTML = sys_JSON.longitude;
		document.getElementById("altitude_text").innerHTML = sys_JSON.altitude;
	});
...
function loadJSON(callback) {
	...
	xobj.open('GET', 'sysloc0.json', true);
